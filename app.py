...
with col10:
    ...
    with filtro_container:
        ...
        with coluna_captacao:
                #Filtro de área
                captacao_opcoes = ['Todas', 'Superficial', 'Subterrânea', 'Sem informação']
                captacao_selectbox = [opcao for opcao in captacao_opcoes if opcao in dados['Tipo de manancial'].unique()]
