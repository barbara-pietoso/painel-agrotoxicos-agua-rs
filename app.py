...
with col10:
    ...
    with filtro_container:
        ...
        with coluna_captacao:
                ...
                dados_filtrados = dados_detec.dropna(subset=["Latitude", "Longitude"]).reset_index(drop=True)
                dados_filtrados['Parametros detectados'].fillna('Verificando', inplace=True).reset_index(inplace=True)
